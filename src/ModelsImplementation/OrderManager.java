...
public class OrderManager implements IOrderManager{
    ...
    public static void main(String[] args) throws NotFound{
        ...
        //ArrayList <Pair<IBook, Integer>> x = new ArrayList<>();
        //x.add(new Pair(new Book("LLIU"),5));
        //x.add(new Pair(new Book("OOIU"),5));
        //mng.addOrder(new User(5), "545335", new Date(System.currentTimeMillis()), x);
        System.out.println(mng.getOrderById(3));
    
        IOrder order = mng.getOrderById(3);
        System.out.println(order.getBooks().size());
        System.out.println(order.getCreditCardNo());
        System.out.println(order.getCreditExpiryDate());
        System.out.println(order.getId());
        System.out.println(order.getTimeStamp());
        System.out.println(order.getTotalPrice());
        System.out.println(order.getUser().getFName());
